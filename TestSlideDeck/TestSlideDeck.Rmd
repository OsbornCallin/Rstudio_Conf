---
title: "Hello my name is Callin Osborn"
author: "Callin"
date: "`r Sys.Date()`"
output: 
...
```{r photo, echo = FALSE}
knitr::include_graphics("https://github.com/CallinOsborn.png") # update USERNAME here
```
...
# getting the data
namedata <- babynames %>%
  dplyr::filter(name == params$name1 | #<<
           name == params$name2) %>% 
  dplyr::filter(sex == "F") 
```
...
```{r topyear-name2}
topyears %>% 
  dplyr::filter(name == params$name2)
```
